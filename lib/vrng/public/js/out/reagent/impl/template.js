...
var G__19909 = o;
(G__19909[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_19913 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_19913))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_19913)].join(''):class$));
} else {
}
...
var G__19916 = jsprops;
(G__19916["defaultValue"] = value);

(G__19916["onChange"] = ((function (G__19916,v,value,on_change){
return (function (p1__19914_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19914_SHARP_);
});})(G__19916,v,value,on_change))
);
...
var vec__19918 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__19918,(0),null);
var id = cljs.core.nth.call(null,vec__19918,(1),null);
var class$ = cljs.core.nth.call(null,vec__19918,(2),null);
...
var temp__4659__auto__ = (function (){var G__19922 = cljs.core.meta.call(null,v);
if((G__19922 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__19922);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__19924_19925 = v;
var G__19924_19926__$1 = (((G__19924_19925 == null))?null:reagent.impl.template.key_from_vec.call(null,G__19924_19925));
if((G__19924_19926__$1 == null)){
} else {
(jsprops["key"] = G__19924_19926__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__19929 = cljs.core.meta.call(null,argv);
if((G__19929 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__19929);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__19930 = (((jsprops == null))?{}:jsprops);
(G__19930["key"] = key);
...
var G__19931 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__19931;
continue;
}
} else {
...
var n__19273__auto___19932 = a.length;
var i_19933 = (0);
while(true){
if((i_19933 < n__19273__auto___19932)){
(a[i_19933] = reagent.impl.template.as_element.call(null,(a[i_19933])));
...
var a = cljs.core.into_array.call(null,s);
var n__19273__auto___19935 = a.length;
var i_19936 = (0);
while(true){
if((i_19936 < n__19273__auto___19935)){
var val_19937 = (a[i_19936]);
if((cljs.core.vector_QMARK_.call(null,val_19937)) && ((reagent.impl.template.key_from_vec.call(null,val_19937) == null))){
(o["no-key"] = true);
} else {
}

(a[i_19936] = reagent.impl.template.as_element.call(null,val_19937));

var G__19938 = (i_19936 + (1));
i_19936 = G__19938;
continue;
} else {
}
...
var G__19940 = (cljs.core.count.call(null,argv) - first_child);
switch (G__19940) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__19940){
