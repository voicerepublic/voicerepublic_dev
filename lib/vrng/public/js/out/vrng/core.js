...
var len__19428__auto___26231 = arguments.length;
var i__19429__auto___26232 = (0);
while(true){
if((i__19429__auto___26232 < len__19428__auto___26231)){
args__19435__auto__.push((arguments[i__19429__auto___26232]));

var G__26233 = (i__19429__auto___26232 + (1));
i__19429__auto___26232 = G__26233;
continue;
} else {
}
break;
...
var keys = cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__26229_SHARP_){
return clojure.string.split.call(null,p1__26229_SHARP_,".");
}),key));
...
vrng.core.t.cljs$lang$applyTo = (function (seq26230){
return vrng.core.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26230));
});
vrng.core.talks_by_state = (function vrng$core$talks_by_state(talk_state){
return cljs.core.filter.call(null,(function (p1__26234_SHARP_){
return cljs.core._EQ_.call(null,talk_state,new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(p1__26234_SHARP_));
...
return cljs.core.swap_BANG_.call(null,vrng.core.state,(function (p1__26235_SHARP_){
return cljs.core.assoc_in.call(null,p1__26235_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"talks","talks",1628751880),cljs.core.keyword.call(null,talk_id),new cljs.core.Keyword(null,"state","state",-1988618099)], null),talk_state);
}));
});
...
return fayeClient.subscribe(vrng.core.venue_channel,(function (p1__26236_SHARP_){
return vrng.core.venue_message_handler.call(null,cljs.core.js__GT_clj.call(null,p1__26236_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true));
}));
});
