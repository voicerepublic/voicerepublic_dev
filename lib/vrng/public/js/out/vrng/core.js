...
var len__19428__auto___25603 = arguments.length;
var i__19429__auto___25604 = (0);
while(true){
if((i__19429__auto___25604 < len__19428__auto___25603)){
args__19435__auto__.push((arguments[i__19429__auto___25604]));

var G__25605 = (i__19429__auto___25604 + (1));
i__19429__auto___25604 = G__25605;
continue;
} else {
}
break;
...
var keys = cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__25601_SHARP_){
return clojure.string.split.call(null,p1__25601_SHARP_,".");
}),key));
...
vrng.core.t.cljs$lang$applyTo = (function (seq25602){
return vrng.core.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25602));
});
vrng.core.talks_by_state = (function vrng$core$talks_by_state(talk_state){
return cljs.core.filter.call(null,(function (p1__25606_SHARP_){
return cljs.core._EQ_.call(null,talk_state,new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(p1__25606_SHARP_));
