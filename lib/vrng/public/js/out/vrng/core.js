...
var len__19428__auto___28450 = arguments.length;
var i__19429__auto___28451 = (0);
while(true){
if((i__19429__auto___28451 < len__19428__auto___28450)){
args__19435__auto__.push((arguments[i__19429__auto___28451]));

var G__28452 = (i__19429__auto___28451 + (1));
i__19429__auto___28451 = G__28452;
continue;
} else {
}
break;
...
var keys = cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__28448_SHARP_){
return clojure.string.split.call(null,p1__28448_SHARP_,".");
}),key));
...
vrng.core.t.cljs$lang$applyTo = (function (seq28449){
return vrng.core.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28449));
});
vrng.core.talks_by_state = (function vrng$core$talks_by_state(talk_state){
return cljs.core.filter.call(null,(function (p1__28453_SHARP_){
return cljs.core._EQ_.call(null,talk_state,new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(p1__28453_SHARP_));
...
return cljs.core.swap_BANG_.call(null,vrng.core.state,(function (p1__28454_SHARP_){
return cljs.core.assoc_in.call(null,p1__28454_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"talks","talks",1628751880),cljs.core.keyword.call(null,talk_id),new cljs.core.Keyword(null,"state","state",-1988618099)], null),talk_state);
}));
});
...
return fayeClient.subscribe(vrng.core.venue_channel,(function (p1__28455_SHARP_){
return vrng.core.venue_message_handler.call(null,cljs.core.js__GT_clj.call(null,p1__28455_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true));
}));
});
