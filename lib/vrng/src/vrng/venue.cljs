...
(defn generic-devices []
  [{:id "bcms"    :name "BroadcastMyself (Android)"}
   ...
   {:id "butt"    :name "B.U.T.T. (Cross Platform)"}
...
(defn instructions-to-disconnect-comp []
  [:div.medium {:id "instructions"}
   [:h4 "alert"]
    [:p "Please disconnect your streaming client. This message will disappear as soon as it is disconnected."]])
