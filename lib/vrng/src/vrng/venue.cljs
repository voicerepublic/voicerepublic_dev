  ...
  [:div#screen1
   ...
   [:ul.menu.vertical.medium-horizontal.text-center
    [:li.box-select
     [:div.itemwrapper 
      [:a
           {:on-click #(wizard-page-action "box")}
           [icon-comp "box"]]
     [:br]
     "VR Box"]]
    [:li.laptop-select
     [:div.itemwrapper 
      [:a
           {:on-click #(wizard-page-action "laptop")} [icon-comp "laptop"]]
     [:br]
     "Laptop"]]
    [:li.mobile-select
     [:div.itemwrapper 
      [:a
           {:on-click #(wizard-page-action "mobile")} [icon-comp "mobile"]]
     [:br]
     "Mobile"]]]])
...
(defn devices-wizard-comp []
  [:div#devices-wizard {:class (:wizard-page @page-state)}
