...
(defn instructions-comp []
  (if (venue-in-state ["awaiting_stream"])
    (condp = (venue-device-name)
      "butt"    [:div.instruction-container {:data-closable ""} [instructions-for-butt-comp]]
      "darkice" [:div.instruction-container {:data-closable ""} [instructions-for-darkice-comp]]
      "generic" [:div.instruction-container {:data-closable ""} [instructions-for-generic-comp]]
      nil nil)))
