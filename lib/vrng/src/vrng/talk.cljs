...
(defonce slides (atom {:width 300 :height 150}))
...
(defn initialize-pdf
  ...
  [this]
  (swap! slides assoc :width (.-width (.getBoundingClientRect (.getElementById js/document "slides-container"))))
