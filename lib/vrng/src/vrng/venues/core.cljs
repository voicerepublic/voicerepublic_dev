...
;; TODO this should become green once the talk is started
             ...
             (let [old-state (get-in old [:venue :state])
               ...
               (if (not= old-state new-state)
                 (case [old-state new-state]
                   ...
                   ["offline" "available"]
                   (add-server-message "Your streaming server is ready to be launched.")

                   ["available" "provisioning"]
                   (add-server-message "Your streaming server is launching...")
