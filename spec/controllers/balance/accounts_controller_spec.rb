...
describe Balance::AccountsController do

  # This should return the minimal set of attributes required to create a valid
  # Balance::Account. As you add validations to Balance::Account, be sure to
  ...
  # Balance::AccountsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
