...
xml.config{
      ...
      xml.skinning(:enabled => "true", :url => "/kluuu/bbb/branding/css/kluuu.css.swf?v=5")
      ...
      xml.modules{
      	...
      	xml.module(:name => "ChatModule", :url => "/kluuu/bbb/ChatModule.swf?v=5", 
		...
		xml.module(:name => "PresentModule", :url => "/kluuu/bbb/PresentModule.swf?v=5", 
			:uri => "rtmp://#{@video_server_address}/bigbluebutton", 
      	...
      	xml.module(:name => "ViewersModule", :url => "/kluuu/bbb/ViewersModule.swf?v=5", 
			:uri => "rtmp://#{@video_server_address}/bigbluebutton", 
		...
		xml.module(:name => "VideoconfModule11", :url => "/kluuu/bbb/VideoconfModule11.swf?v=5", 
		...
		xml.module(:name => "VideoconfModule103", :url => "/kluuu/bbb/VideoconfModule103.swf?v=5", 
			:uri => "rtmp://#{@video_server_address}/video",
			:dependsOn => "ViewersModule",
			:videoQuality => "80",
			:presenterShareOnly => "false",
      	...
      	xml.module(:name => "PaymentModule", :url => "/kluuu/bbb/PaymentModule.swf?v=5", 
			:credit => @credit,
			:ttp => @time_to_pay)
