class ParticipationsController < ApplicationController
  ...
  def create
    ...
    @participation.user_id = guest_or_current_user.id
    ...
    respond_to do |format|
      if @participation.save
        format.html do
          ...
          if @venue.live?
            markup = render_to_string partial: 'venues/venue_show_avatar', locals: { user: guest_or_current_user }
  ...
  def destroy
    #@participation = Participation.find(params[:id])
    @participation = guest_or_current_user.participations.find_by_venue_id(params[:venue_id])
